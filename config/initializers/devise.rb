...
Devise.setup do |config|
  ...
  # config.secret_key = 'bf52a5cf16d2dae0db22463326a62ae21852e131de131faae1fbbf70b097463de0dfdbb8f58609566c6577546c1025ef1e766cff3b0067c7ff975042b393036f'
  ...
  # config.pepper = 'a261ca5afeed7a1b192515d7104b49ee4e7fc1373156081943583199939df990030ee76fd5ce1a968f56b227a942c85cb25215e84971494151a4b89fbaa077ad'
  ...
  # <---- LESSON ---->
  # Step Seven:
  # Here is where we are making calls to the credentials file we just created.
  ...
  # Step Eight:
  # Create a file in /config/initializers called "session_store.rb"
